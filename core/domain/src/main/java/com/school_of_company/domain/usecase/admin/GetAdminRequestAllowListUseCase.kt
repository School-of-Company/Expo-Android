...
class GetAdminRequestAllowListUseCase @Inject constructor(
    private val repository: AdminRepository
) {
    operator fun invoke(): Flow<List<AdminRequestAllowListResponseEntity>> =
        repository.getAdminRequestAllowList()
}